...
import com.example.kktext_testing.databinding.ActivityLoginBinding
import com.example.kktext_testing.viewmodelactivity.LoginViewModel
        ...
        try {
            ...
            if (tag == ApiContants.login) {
                ...
                if (loginModel.error==false) {
                    ...
                    PrefManager.putString(ApiContants.Designation,  loginModel.data.designation )
                    PrefManager.putString(ApiContants.Name,  loginModel.data.name)
                    PrefManager.putString(ApiContants.UserType,  loginModel.data.userType )
