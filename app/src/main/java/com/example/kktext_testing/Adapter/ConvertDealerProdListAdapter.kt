...
import com.example.kktext_testing.Model.ConvertedDealerBean
import com.example.kktext_testing.Model.LeadDetailBean
import com.example.kktext_testing.R
import com.example.kktext_testing.Utills.GeneralUtilities
import com.example.kktext_testing.Utills.RvListClickListner
...
class ConvertDealerProdListAdapter(
    var context: Activity,
    var list: List<ConvertedDealerBean.Data.LeadProduct>,
    var rvClickListner: RvListClickListner
) : RecyclerView.Adapter<ConvertDealerProdListAdapter.MyViewHolder>() {
